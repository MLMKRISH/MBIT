...
“If you understood in 1995 the opportunities and threats that the internet would ultimately present
to your company, or industry, what would you have done differently? That is where we are with
blockchain today.&quot;. -Ginni Rometty, CEO of IBM,
The first wave of the internet never totally fulfilled its promise of distributing wealth and authority
...
other, without any middle men or intermediaries. This is because the system itself works as a
mechanism to create transparency and trust by being neutral. Since there is no central authority,
abuse of power is prevented as power is decentralized and distributed.
...
person, a business, or a computer operating automatically, or whatever else — let alone understand
...
There are few approaches of creating consensus in a blockchain: the proof-of- work algorithm(PoW)
,the proof-of- stake algorithm (PoS), and the delegated proof-of- stake algorithm (DPoS).
...
ensure that dishonest information will fail to compute in an suitable way. In the Bitcoin system, the
...
A next method of achieving consensus on blockchain systems is developed such that involvement in
the consensus-achieving method is limited to entities acknowledged as having a sincere stake in the

blockchain. This method is called proof-of- stake (PoS) algorithms. Here the hash function calculation
is replaced with a digital signature which proves rights of the stake. The network selects an entity to
approve new information based on their relative stake in the network. In PoS, the network
mechanism runs a lottery and the lottery winner announces the results. The system members are
automatically enter the lottery relative to their total stake in the network as compared to PoS where
entities attempt to calculate valid hashes in order to be chosen to establish consensus. NEO, Waves
use variations of the PoW system to incentize participation. Ethereum is also planning to shift to PoS
shortly.
These consensus mechanisms help to prevent hacks as hackers will have to compete with most of
honest system entities. This network effect helps securing all the data on Blockchain. Compare this
to a centralised institution which is vulnerable to hacks because the hacker would require hacking
into only one main system. This single point of control is also the single point of failure, which can
lead to disastrous security breaches. Distributing the ledger to millions of nodes protects the data. It
is impossible to hack all the nodes at the same time. Even if the hacker attempts, the neighbouring
nodes would invalidate.
Because the ownership of Blockchain can be decentralized, no central authority can take control, but
rather, all transactions are validated using Blockchain Network using the inbuilt Consensus
mechanism.
We can also classify blockchains as Public and Private basis the access to data on Blockchain.
Public Blockchains
In public blockchains no one controls information on the blockchain or the laws of the blockchain.
Information on blockchain is totally transparent as is accessible to all network members. No member
can alter the protocols of the blockchain unless approved by other network members. It is open to
everyone and anyone who wants to transact/verify as part of the network.
...
for developers and innovators to create diverse array of distributed applications called DApps.
...
directly written into lines of code. [2]

Bitcoin and Ethereum are two leading public blockchains. There are a lot other like Waves, Neo,
Litecoin and Dash. In the future, there are likely to be many simultaneously functioning digital
currencies, tokens and blockchains.
NEM Blockchain
NEM Blockchain has evolved to be one best platform to deploy custom tokens. In addition,
...
NEW also has a large thriving community that includes entrepreneurs, businesses and service
providers, investors, developers, marketing and social media experts, holders, traders, and
more — all of whom want to see the platform succeed.
...
resolve some of the world’s most difficult problems. [4]
Its technology can provide power to the masses. It can impact individuals, businesses and societies in
innumerable ways.

With blockchain, we can imagine a world where contracts are amalgamated in digital code and
stored in transparent, shared databases, where they are protected from deletion, tampering, and
revision. In this world every agreement, every process, every task, and every payment would have a
digital record and signatures that can be identified, validated, stored, and shared. Intermediaries like
lawyers, brokers, and bankers will no longer be necessary. Individuals, organisations, machines and
algorithms would freely and directly transact and interact frictionless. Everything is streamlined. This
is the immense potential of blockchain.
Permissioned enterprise DLT applications are a natural next step for companies. We’re seeing a lot
of investment in private blockchain networks right now, and the projects involved seem poised for
...
Blockchain is a foundational technology: It has the potential to create new foundations for our
...
There are countries like Estonia and Dubai are planning to shift governance onto Blockchain already.
[5] [6] The logical extension to this will that in the future the entire human race can be self-governed
and interact through DLT.
...
Blockchain
ApplicationsMiningHedge funds
(BitsBank)

I. Blockchain Applications
Customer loyalty and engagement can make or break businesses, and as such, loyalty
rewards programs represent strategic investments for all types of business. We suppose that
you and possibly every adult you know is enrolled in some form of loyalty program.
Therefore, MBit is planning to develop an blockchain application to cater the loyalty sector.
Please refer to section 4 below for more details.
II. Mining
Our resources are dedicated to lucrative crypto-currency mining at our advanced mining
farms with hundreds of connected machines. We use best-in- class GPUs for mining with
hash rate of 14 Terahash / second (TH/s). Our focus on constant enhancement ensures that
we are continually upgrading to the best hardware innovation, thus phasing out older
machines.
III. Hedge funds
Crypto-currency trading and managing crypto funds is based on similar principles as trading
Sensex. It has seen wide scale acceptance among the investor community. MBit has put in
place a top of line methodology to trade different currencies. Our investment team has vast
experience in trading and more specifically in Crypto-currency trading. We trade in almost all
available Crypto-currencies and conduct trading and related activities for over 500
...
designed in a manner which rewards its members who have placed their valuable trust in Mbit.
Because trust in the MBit system equates to ownership. This is means that whoever is a member of
the MBit ecosystem and trusts Mbit, automatically becomes an owner and can enjoy the profits of
the organisation.
...
MBIT Classic Coin can be compared to ‘company equity’ and MBIT Classic Coin holders as ‘equity
holders’ in traditional business terms. While this is not totally accurate in business terms, replacing
those words while reading the rest of this whitepaper may be convenient.

Token Technology

We will be using NEM Blockchain to deploy MCC. MCC tokens can be issued, transferred, swapped
and traded directly using the Waves blockchain. It’s a powerful, quick, scalable platform that
...
technology provides an ecosystem can be created where any merchant can join run hyperlocal and
loyalty programs. This means a win-win scenario is created where customers and merchants can
truly enjoy the potential of brand and hyperlocal marketing and loyalty.
...
Hyperlocal market will increase at a significant CAGR rate and will exceed Rs. 2,306 crores by 2020.
...
Retailing in India is mostly unorganized. According to a survey by AT Kearney, a large percentage of
the Rs. 400,000 crore retail markets are unorganized in India. Also, only a Rs. 20,000 crore segment
of the market is organized. The segment is highly fragmented with 97% of its business being run by
the unorganized retailers such as traditional family run stores and kirana stores. This sector is the
biggest source of employment after agriculture. It also has a deep penetration into rural India and
generates more than 10% of India’s GDP. Unorganized retailers consists of the local kirana stores,
...
technology which can help them in deploying hyperlocal marketing. If the unorganised retails sector
...
by 25% to 85% basis on the business sector. [9]
Big brands recognize this and as the share of organized retail sector grows, such loyalty programs are
becoming prevalent. Also, loyalty works as a crucial relationship tool and is now an important
...
No wonder the market potential of loyalty sector in India is poised at Rs 8,500 crore today. [10]
...
access are part of one or more loyalty programs, global survey company Nielsen noted.

Despite the progress in loyalty program involvement, various issues have stopped these programs
from realizing their full potential. Noted problems include low redemption rates, high operational
costs, account inactivity and other logistical concerns as hindrances to improving customer loyalty.
Loyalty programs need to cater to these issues and focus on consumer preference. As per a Nielsen
study, the most appreciated rewards in loyalty programs are monetary. Therefore, such programs
...
include existing customers to run hyperlocal marketing and showcase various offers on the MBit
User App.
...
can function transparently and securely so that there is total trust.
...
service and products. Therefore, such stores which provide great quality of service and products
...
Token mechanics
ROYYAL will be based on the NEM Blockchain platform. This will be stable at this price point as
ROYYAL token can only be used in its own ecosystem and cannot be traded with any other currency
i.e. ROYYAL can be used only for trading goods and service on the MBit ecosystem.
...
these tokens back at the supermarket as the loves the convenience, quality and service of the
supermarket and he is getting a good discount by redeeming his ROYYAL tokens during purchase.
...
Sam to share some tokens. Sam transfers ROYYAL to John using the app and a happy John redeems
them to get a good discount.
...
implement are appearing. For instance, digital wallet AliPay is adding a bitcoin option for its
customers. Visa has partnered with blockchain company Chain to build Visa B2B Connect, an
enterprise blockchain infrastructure to facilitate international financial transactions for their
corporate clients.
...
development and testing its applications. Investment in blockchain is gaining momentum, with
approximately $1 billion of venture capital investment over the last 24 months ($500 million in 50
venture capital deals in 2016 alone) and the trend is expected to grow rapidly.
...
companies, start-ups, and other stakeholders.
...
grown to include more than 70 global banks, which reportedly were due to governance conflicts.
Corda, its underlying protocol, is technically more of a messaging protocol. Ripple, which proposes a
blockchain-like technology and network for faster settlement of payments around the globe, has
more than 75 banking clients globally.
A huge portion of the total venture capital investment has been captured by a handful of start-ups in
the digital wallet and capital market services space ($625 million) Regardless of their origin, these
new players are targeting segments closely related to the economic activity of developing markets,
such as global remittances.
The blockchain innovation landscape is still dominated by the United States and Europe. The United
States represents 54 percent of the blockchain global deal share, followed closely by Western
Europe.93 This dominance is, however, being challenged by Asia, according to a 2016 CB Insights
analysis of venture capital financing. It shows that Asia, driven by China, increased its share of the
pie from 14 percent in 2015 to 23 percent in 2016, a remarkable rise.
IBM released a report in 2016 which suggests that by 2020, 66% of all banks will have blockchain in
...
Growth Rate (CAGR) of 79.6%. In other words, there’s room for plenty of opportunities for investors
to benefit from in this exciting–and expanding–market.
The banking and finance industries aren’t the only ones adopting blockchain technology. For
example, it has been used in securing elections, and big companies are also making the leap into
blockchain; Capital One has confirmed a blockchain project, partnering with Gem on healthcare
claims.
